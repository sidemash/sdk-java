...
public final class StreamMetaData {
    ...
    public static final String Type = "StreamMetaData";

    @JsonCreator
    protected StreamMetaData(@JsonProperty("todo") int todo) {
        this.todo = todo;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StreamMetaData)) return false;
    ...
    public String toString() {
        return "StreamMetaData{todo=" + todo + '}';
    }
}