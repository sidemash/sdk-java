...
public final class UserDesc {
    private final int todo;

    public static final String Type = "UserDesc";

    @JsonCreator
    protected UserDesc(@JsonProperty("todo") int todo) {
        this.todo = todo;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserDesc)) return false;
        UserDesc other = (UserDesc) o;
